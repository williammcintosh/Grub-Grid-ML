...
max_cutoff = int(sys.argv[1])
file_name = "_cleanedup_RAW_interactions"
fn = "/Users/willmcintosh/DataSciencePractice/"+str(max_cutoff)+file_name+".csv"
...
columns_headers.to_csv(str(max_cutoff)+"_column_headers.csv")
index_headers.to_csv(str(max_cutoff)+"_index_headers.csv")
...
save_npz(path+str(max_cutoff)+"_cleanedup_"+file_name+".csv", arr)
